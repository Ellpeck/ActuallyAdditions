...
public class TileEntityBioReactor extends TileEntityInventoryBase implements ISharingEnergyProvider{
    ...
    public TileEntityBioReactor(){
        super(8, "bioReactor");
        this.storage = new CustomEnergyStorage(ConfigIntValues.BIO_REACTOR_ENERGY_CAPACITY.getValue(), 0, ConfigIntValues.BIO_REACTOR_ENERGY_SEND.getValue());
    }
    ...
    public void updateEntity(){
        ...
        if(this.burnTime <= 0){
            ...
            if(types != null && !types.isEmpty()){
                ...
                this.producePerTick = (int)Math.pow(amount * ConfigIntValues.BIO_REACTOR_ENERGY_PER_ITEM.getValue(), 2);
