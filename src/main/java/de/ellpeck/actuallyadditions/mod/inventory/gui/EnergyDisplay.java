...
public class EnergyDisplay extends Gui {
    ...
    private String getOverlayText() {
        ...
        return String.format("%s/%s "+I18n.format("actuallyadditions.cflong"), format.format(this.rfReference.getEnergyStored()), format.format(this.rfReference.getMaxEnergyStored()));
    }
}
