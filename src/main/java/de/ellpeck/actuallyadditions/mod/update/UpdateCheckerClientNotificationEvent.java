        ...
        if(!notified && Minecraft.getMinecraft().thePlayer != null){
            ...
            if(ticksElapsedBeforeInfo >= 800){
                ...
                if(UpdateChecker.checkFailed){
                    ...
                    player.addChatComponentMessage(IChatComponent.Serializer.jsonToComponent(StringUtil.localizeFormatted("info."+ModUtil.MOD_ID_LOWER+".update.versionCompare", ModUtil.VERSION, UpdateChecker.updateVersion)));
