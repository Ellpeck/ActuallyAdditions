...
public final class ActuallyItems {
    ...
    public static final RegistryObject<Item> CU_BA_RA_JAM = ITEMS.register("cu_ba_ra_jam", basicItem());
    public static final RegistryObject<Item> GRA_KI_BA_JAM = ITEMS.register("gra_ki_ba_jam", basicItem());
    public static final RegistryObject<Item> PL_AP_LE_JAM = ITEMS.register("pl_ap_le_jam", basicItem());
    public static final RegistryObject<Item> CH_AP_CI_JAM = ITEMS.register("ch_ap_ci_jam", basicItem());
    public static final RegistryObject<Item> HO_ME_KI_JAM = ITEMS.register("ho_me_ki_jam", basicItem());
    public static final RegistryObject<Item> PI_CO_JAM = ITEMS.register("pi_co_jam", basicItem());
    public static final RegistryObject<Item> HO_ME_CO_JAM = ITEMS.register("ho_me_co_jam", basicItem());
